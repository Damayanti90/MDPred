# -*- coding: utf-8 -*-
"""github_md_LightGBM_link_classification.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1f7OaNFid0FsEjkVUJu7uMmRMNOD9hWqY
"""
...
fs=open(r"trial_info_lgbm.txt","w")
...
xgb_model= lgb.LGBMClassifier(**param, verbosity=-1,random_state=42)
...
print(auprc_tot[0])
count=0
fs=open(r"performance-lgbm.txt","w")
...
fs=open(r"average_performance_metrics_lgbm.txt","w")
...
count=0
c=0
fs=open(r"result_test_data_lgbm.txt","w")
...
count=0
c=0
fs=open(r"result_drug_go_prediction_data_lgbm.txt","w")
#fs=open(r"gdrive/MyDrive/trio-stuff/result/result_test_protein_go_1.txt","w")
for i in range(len(pred_lst)):
    count+=1
    s=""
...
count=0
c=0
fs=open(r"result_drug_pathway_prediction_data_lgbm.txt","w")
#fs=open(r"gdrive/MyDrive/trio-stuff/result/result_test_protein_go_1.txt","w")
for i in range(len(pred_lst)):
    count+=1
    s=""
